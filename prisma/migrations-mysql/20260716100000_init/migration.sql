...
CREATE TABLE `users` (
    ...
    INDEX `IDX_users_active_created_at`(`active`, `createdAt`),
    UNIQUE INDEX `UQ_users_country_phone`(`countryCode`, `phone`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `tenant_memberships` (
    ...
    INDEX `IDX_memberships_tenant_active_created_at`(`tenantId`, `active`, `createdAt`),
...
CREATE TABLE `roles` (
    ...
    INDEX `IDX_roles_tenant_enabled_code`(`tenantId`, `enabled`, `code`),
    UNIQUE INDEX `UQ_roles_tenant_code`(`tenantId`, `code`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `user_role_assignments` (
    ...
    INDEX `IDX_user_roles_tenant_role`(`tenantId`, `roleId`),
    INDEX `IDX_user_roles_role_id`(`roleId`),
    PRIMARY KEY (`userId`, `tenantId`, `roleId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `refresh_tokens` (
    ...
    UNIQUE INDEX `IDX_refresh_tokens_token_hash`(`tokenHash`),
...
CREATE TABLE `processed_events` (
    ...
    `routingKey` VARCHAR(120) NOT NULL,
    `processedAt` TIMESTAMP(0) NOT NULL,
    `expiresAt` TIMESTAMP(0) NOT NULL,
